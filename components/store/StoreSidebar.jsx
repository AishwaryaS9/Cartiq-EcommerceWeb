            ...
            <div className="max-sm:mt-6">
                {
                    sidebarLinks.map((link, index) => (
                        <Link key={index} href={link.href} className={`relative flex items-center gap-3 text-customBlack hover:bg-slate-50 p-2.5 transition ${pathname === link.href && 'bg-slate-100 sm:text-customBlack/90'}`}>
