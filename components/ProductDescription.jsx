        ...
        <div className="my-18 text-sm text-slate-600">
            ...
            {selectedTab === "Reviews" && (
                <div className="flex flex-col gap-3 mt-14">
                    {product.rating.length === 0 && <p>No Reviews found</p>}
            ...
            <div className="flex gap-3 mt-14">
                ...
                <div>
                    ...
                    <Link href={`/shop/${product.store.username}`} className="flex items-center gap-1.5 text-primary font-medium"> view store <ArrowRight size={14} /></Link>
                </div>
            </div>
        </div>
    )
