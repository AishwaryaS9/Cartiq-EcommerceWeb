...
export default function PrivacyPolicy() {
  return (
    <div className="max-w-4xl mx-auto p-8">
      ...
      <h2 className="text-xl font-normal mt-6 mb-2 text-gray-800">1. Information We Collect</h2>
      <p className="text-gray-700 mb-4">
      ...
      <h2 className="text-xl font-normal mt-6 mb-2 text-gray-800">2. How We Use Your Information</h2>
      <p className="text-gray-700 mb-4">
      ...
      <h2 className="text-xl font-normal mt-6 mb-2 text-gray-800">3. Data Security</h2>
      <p className="text-gray-700 mb-4">
        We use industry-standard encryption and security measures to protect your information
        from unauthorized access, disclosure, or misuse.
      </p>

      <h2 className="text-xl font-normal mt-6 mb-2 text-gray-800">4. Your Rights</h2>
      <p className="text-gray-700 mb-4">
      ...
      <p className="text-gray-700 mt-6">
        ...
        <a href='mailto:privacy@cartiq.com' className="font-medium"> privacy@cartiq.com</a>.
      </p>
    </div>
  )
}
